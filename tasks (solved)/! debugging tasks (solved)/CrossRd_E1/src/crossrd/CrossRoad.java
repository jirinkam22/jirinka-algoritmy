...
public class CrossRoad extends Pane {
    ...
    public CrossRoad(){
        sem1 = Semaphore(300,110); sem1.setRotate(180);
        sem2 = Semaphore(440,340); sem2.setRotate(0);
        sem3 = Semaphore(260,290); sem3.setRotate(90);
        sem4 = Semaphore(485,155); sem4.setRotate(270);
